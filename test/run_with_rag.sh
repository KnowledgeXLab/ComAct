# ----------------------------------
# Evaluation on ComCADBench with rag
# ----------------------------------
TRIAL_ID=0
MAX_STEPS=6
...
for i in $(seq 0 $((NUM_WORKERS - 1))); do
  python run.py \ 
    ...
    --result_dir results/results_with_rag/results_3d_model \
...
for i in $(seq 0 $((NUM_WORKERS - 1))); do
  python run.py \
    ...
    --result_dir results/results_with_rag/results_assembly \
    --num_workers $NUM_WORKERS \
    --worker_id "$i" \
    --sandbox_info_file $SANDBOX_INFO_FILE \
    --task_type 'assembly' \
...
for i in $(seq 0 $((NUM_WORKERS - 1))); do
  python run.py \
    ...
    --result_dir results/results_with_rag/results_2d_sketch \
    --num_workers $NUM_WORKERS \
    --worker_id "$i" \
    --sandbox_info_file $SANDBOX_INFO_FILE \
    --task_type '2d_sketch' \
...
for i in $(seq 0 $((NUM_WORKERS - 1))); do
  python run.py \
    ...
    --result_dir results/results_with_rag/results_3d_model+drawing \
    --num_workers $NUM_WORKERS \
    --worker_id "$i" \
    --sandbox_info_file $SANDBOX_INFO_FILE \
...
for i in $(seq 0 $((NUM_WORKERS - 1))); do
  python run.py \
    ...
    --result_dir results/results_with_rag/results_3d_model+mass_property \
    --num_workers $NUM_WORKERS \
    --worker_id "$i" \
    --sandbox_info_file $SANDBOX_INFO_FILE \
...
for i in $(seq 0 $((NUM_WORKERS - 1))); do
  python run.py \
    ...
    --result_dir results/results_with_rag/results_assembly+interference_detection \
    --num_workers $NUM_WORKERS \
    --worker_id "$i" \
    --sandbox_info_file $SANDBOX_INFO_FILE \
...
for i in $(seq 0 $((NUM_WORKERS - 1))); do
  python run.py \
    ...
    --result_dir results/results_with_rag/results_3d_model+modify \
    --num_workers $NUM_WORKERS \
    --worker_id "$i" \
    --sandbox_info_file $SANDBOX_INFO_FILE \
